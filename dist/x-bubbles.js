...
/***/ function(module, exports, __webpack_require__) {
	...
	function (_HTMLDivElement) {
	  ...
	  function XBubbles() {
	    ...
	    _this = _possibleConstructorReturn(this, _getPrototypeOf(XBubbles).call(this));
	    initEditor(_assertThisInitialized(_this));
	    utils.ready(_assertThisInitialized(_this));
	    return _this;
	  }
